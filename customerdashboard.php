			...
			<div class="container-fluid checkout p-0">
				...
				<div class="card">
					...
					<p class="card-text">
						...
						<span>&emsp;&nbsp;Please send your cheque to SN Book Store in its given address or you can make cash payment as well.</span>
					</p>
					<p class="card-text"><input class="form-check-input" type="radio" checked> Online Payment
						<span>
							...
							data-key="<?php echo $publishableKey?>" data-amount="<?php echo $item_total * 100;?>" data-name = "" data-description="Payment Gateway" data-image="" data-currency="npr"
							data-email="">
							</script>	
