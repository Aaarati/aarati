    ...
    <div id ="register-body">
      <form method = "POST" name = "register">
        ...
        <div id="register-content">
          ...
          <input type="text" name="username" id="name" class="form-control" placeholder="Enter your Username" maxlength="30"><br>
          ...
          <input type="text" name="contact" id="contact"  class="form-control"placeholder="Enter your Mobile number"><br>
          <span id="contact_err"><?php echo $errcontact;?></span>

          <label for="exampleFormControlInput1" class="form-label">Email Address</label><br>
          <input type="text" name="email" id="email"class="form-control" placeholder="Enter your Email Address"><br>
          <span id="email_err"><?php echo $erremail;?></span>

          <label for="password">Password</label><br>
          <input type="password" name="password" class="form-control"id="password" placeholder="Enter your Password"><br>
          <span id="password_err"><?php echo $errpassword;?></span>
          
          <label for="con_password">Confirm Password</label><br>
          <input type="password" name="con_password"class="form-control" id="con_password" placeholder="Re-Enter your Password"><br>
          ...
          <input type="reset"  class="buttons mb-3"id="reset">&nbsp;&nbsp;&nbsp;<br><br>
